...
class VisitorApiTests(TestCase):
    ...
    def test_daily_mapreduce_command_contains_main_class(
        ...
        self.assertIn("/waether/visitor/input", command)
        self.assertNotIn("/waether/visitor/input/visitor_records.csv", command)
        self.assertIn("hdfs dfs -rm -r -f /waether/visitor/output/daily", command)
    ...
    def test_hourly_mapreduce_uses_partition_root(
        ...
        self.assertIn("/waether/visitor/input", command)
        self.assertNotIn("/waether/visitor/input/visitor_records.csv", command)
        self.assertIn("hdfs dfs -rm -r -f /waether/visitor/output/hourly", command)
    ...
    def test_gate_mapreduce_uses_partition_root(
        ...
        self.assertIn("/waether/visitor/input", command)
        self.assertNotIn("/waether/visitor/input/visitor_records.csv", command)
        self.assertIn("hdfs dfs -rm -r -f /waether/visitor/output/gate", command)
